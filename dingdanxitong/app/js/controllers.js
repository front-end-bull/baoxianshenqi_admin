    ...
    var isFirst = true
      ...
      //-start-产品信息配置 
        ...
        function add_block(){
          ...
          var html = '<div style="background-color:'+color+';color:#fff;padding-top:10px;padding-bottom:10px;border-radius:20px;position:relative" id="a_block'+block_num+'"><div class="paper-row row"><div class="col-md-1" style="padding-right:0">产品名称:</div><div class="col-md-2" style="padding-left:0"><select id="block'+block_num+'_name" style="color:black"><option value="7165">泰康乐安康</option><option value="7167">华夏健康人生</option> <option value="7160">华夏常青树2015</option></select></div><div class="col-md-1"></div><div class="col-md-1" style="padding-right:0">保额:</div><div class="col-md-2 add-yuan" style="padding-left:0"><input id="block'+block_num+'_baoe"></div><div class="col-md-1"></div><div class="col-md-1" style="padding-right:0">保费:</div><div class="col-md-2 add-yuan" style="padding-left:0"><input id="block'+block_num+'_baofee"></div><div class="col-md-1"></div></div><div class="paper-row row"><div class="col-md-1" style="padding-right:0">保障期间:</div><div class="col-md-2 add-year" style="padding-left:0"><input id="block'+block_num+'_baozhangqijian"></div><div class="col-md-1"></div><div class="col-md-1" style="padding-right:0">缴费年限:</div><div class="col-md-2 add-year" style="padding-left:0"><input id="block'+block_num+'_jiaofeinianxian"></div><div class="col-md-1"></div></div><div style="position:absolute;left:100%;top:10px;margin-left:-30px" id="block'+block_num+'" onclick="delete_block(this.id)"><i class="glyphicon glyphicon-remove"></i></div></div>';
      ...
      $scope.addStatus = function(){
        var html = '<div class="clearfix"><div style="padding:20px;float:left;">最新状态: &nbsp;<select id="status" style="font-size:20px;"><option value="0">订单初始化</option><option value="2">已预约面签</option><option value="3">材料有误</option><option value="4">材料已提交保险公司</option><option value="5">通知体检</option><option value="6">拒保,订单取消</option><option value="7">调整保费</option><option value="8">拒绝,订单取消</option><option value="9">同意调整保费</option><option value="10">划款失败</option><option value="11">到时限后弃保</option><option value="12">回执已寄出</option><option value="13">回执已提交保险公司</option><option value="14">进入犹豫期</option><option value="15">回访失败</option><option value="17">犹豫期结束</option></select></div>'+
