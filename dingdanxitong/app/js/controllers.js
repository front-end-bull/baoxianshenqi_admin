  ...
  function($scope,$http,$routeParams) {
    ...
    var isFirst = true
      ...
      $scope.addStatus = function(){
        var html = '<div class="clearfix"><div style="padding:20px;float:left;">最新状态: &nbsp;<select id="status" style="font-size:20px;"><option value="0">订单初始化</option><option value="2">已预约面签</option><option value="3">材料有误</option><option value="4">材料已提交保险公司</option><option value="5">通知体检</option><option value="6">拒保,订单取消</option><option value="7">调整保费</option><option value="8">拒绝,订单取消</option><option value="9">同意调整保费</option><option value="10">划款失败</option><option value="18">划款成功</option><option value="19">保险公司下发合同</option><option value="11">到时限后弃保</option><option value="12">合同已转交</option><option value="14">进入犹豫期</option><option value="13">回执已提交保险公司</option><option value="15">回访失败</option><option value="16">回访成功</option><option value="20">犹豫期退保</option><option value="17">佣金已结</option></select></div>'+
      ...
      $scope.updateStatus = function(seq){
        ...
        var html = '<div class="clearfix"><div style="padding:20px;float:left;">最新状态: &nbsp;<select id="status" style="font-size:20px;"><option value="0">订单初始化</option><option value="2">已预约面签</option><option value="3">材料有误</option><option value="4">材料已提交保险公司</option><option value="5">通知体检</option><option value="6">拒保,订单取消</option><option value="7">调整保费</option><option value="8">拒绝,订单取消</option><option value="9">同意调整保费</option><option value="10">划款失败</option><option value="18">划款成功</option><option value="19">保险公司下发合同</option><option value="11">到时限后弃保</option><option value="12">合同已转交</option><option value="14">进入犹豫期</option><option value="13">回执已提交保险公司</option><option value="15">回访失败</option><option value="16">回访成功</option><option value="20">犹豫期退保</option><option value="20">犹豫期退保</option><option value="17">佣金已结</option></select></div>'+
        '<div style="padding:20px;float:left;">更新时间: &nbsp;<input id="status_date" style="padding-left:8px;" onclick="WdatePicker({dateFmt:\'yyyy-MM-dd HH:mm:ss\'})"></div></div>'+
